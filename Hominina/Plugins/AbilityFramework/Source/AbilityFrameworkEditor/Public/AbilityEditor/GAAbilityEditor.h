 ...
 */
class FGAAbilityEditor : public FBlueprintEditor
{
public:
	...
	void InitAbilitiesEditor(const EToolkitMode::Type Mode, const TSharedPtr<IToolkitHost>& InitToolkitHost, const TArray<UBlueprint*>& InBlueprints, bool bShouldOpenInDefaultsMode);
