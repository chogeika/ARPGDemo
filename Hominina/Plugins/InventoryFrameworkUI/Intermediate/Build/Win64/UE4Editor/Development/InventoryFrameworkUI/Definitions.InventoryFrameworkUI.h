#undef INVENTORYFRAMEWORKUI_API
#undef INVENTORYFRAMEWORKUI_VTABLE
...
#define INVENTORYFRAMEWORKUI_VTABLE DLLEXPORT_VTABLE
#define INVENTORYFRAMEWORKUI_API DLLEXPORT
