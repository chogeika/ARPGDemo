 ...
 */
UCLASS()
class HOMININA_API AARPlayerController : public APlayerController, public IIFInventoryInterface
{
	GENERATED_BODY()
public:
...
public:
	...
	void SetPawnARPG(APawn* InPawn); //override; //fix me
	void PossessARPG(APawn* aPawn);// override;//fix me
